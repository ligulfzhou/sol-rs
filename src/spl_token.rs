...
impl SplToken {
    ...
    /// create spl token
    pub fn create_spl_token(&self) -> anyhow::Result<()> {
    ...
    pub fn get_spl_token_balance(&self, holder: Pubkey) -> anyhow::Result<u64> {
    ...
    pub fn get_existing_or_create_ata(&self, receiver: Pubkey) -> anyhow::Result<Pubkey> {
    ...
    pub fn mint_to(&self, receiver: Pubkey, amount: u64) -> anyhow::Result<()> {
